...
% vs];
%
% make vv smaller to make endpoint darker.
% make mv smaller to make high values grayer
%
% In general it is good to make xv>=xs otherwise there is a
% monochromatic region  between xs and xv.  
%
